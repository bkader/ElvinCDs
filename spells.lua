...
local spells = {
  ...
  DRUID = {
    ...
    [50763] = {cooldown = 1, shout = true} -- Revive
  },
  ...
  MAGE = {
    ...
    [130]   = {cooldown = 1, whisper = true}, -- Slow fall
    [43015] = {cooldown = 1, shout = true}, -- Dampen Magic
    [43017] = {cooldown = 1, shout = true}, -- Amplify Magic
    [45438] = {cooldown = 300}, -- Ice Block
    [54646] = {cooldown = 1, talent = true, whisper = true}, -- Focus Magic
  ...
  PALADIN = {
    ...
    [48950] = {cooldown = 1, shout = true}, -- Redemption
    [498]   = {cooldown = 180, track = true, hidden = true}, -- Divine Protection
    [53563] = {cooldown = 1, talent = true}, -- Beacon of Light
  ...
  PRIEST = {
    ...
    [1706]  = {cooldown = 1, whisper = true}, -- Levitate
    ...
    [48171] = {cooldown = 1, shout = true}, -- Resurrection
  ...
  ROGUE = {
    ...
    [51724] = {cooldown = 1, shout = true}, -- Sap
  ...
  SHAMAN = {
    ...
    [49277] = {cooldown = 1, shout = true}, -- Ancestral Spirit
    [51514] = {cooldown = 45, shout = true}, -- HEX
    [51533] = {cooldown = 180, talent = true}, -- Feral Spirit
    [546]   = {cooldown = 1, whisper = true}, -- Water Walking
  ...
  ----------------------------------------------------------------
  WARLOCK = {
    [126]   = {cooldown = 1}, -- Eye of Kilrogg
    [17928] = {cooldown = 1, group = true}, -- Howl of Terror
    [18647] = {cooldown = 1, shout = true}, -- Banish
    ...
    [5697]  = {cooldown = 1, whisper = true}, -- Unending Breath
    [58887] = {cooldown = 300, shout = true}, -- Ritual of Souls
    [6215]  = {cooldown = 1, shout = true}, -- Fear
  ...
  WARRIOR = {
    ...
    [12323] = {cooldown = 1, talent = true}, -- Piercing Howl
    [1715]  = {cooldown = 1}, -- Hamstring
    ...
    [50720] = {cooldown = 1, talent = true, track = true, hidden = true, shout = true, whisper = true}, -- Vigilance
